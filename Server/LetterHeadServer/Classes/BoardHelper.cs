...
namespace LetterHeadServer.Classes
{
    public static class BoardHelper
    {
        ...
        static BoardHelper()
        {
            letters.Add(new LetterDefinition() { letter = 'a', weight = 2f, maxCount = 4});
            ...
            letters.Add(new LetterDefinition() { letter = 'e', weight = 2f, maxCount = 4});
            ...
            letters.Add(new LetterDefinition() { letter = 'i', weight = 2f, maxCount = 4});
            ...
            letters.Add(new LetterDefinition() { letter = 'o', weight = 2f, maxCount = 4});
            ...
            letters.Add(new LetterDefinition() { letter = 't', weight = 1.2f, maxCount = 4});
