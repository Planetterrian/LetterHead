...
public class GameGui : Singleton<GameGui>
{
    ...
    public void OnMatchDetailsLoaded()
    {
        ...
        var scoringType = GameManager.ModeName(GameManager.Instance.MatchDetails.ScoringType);
        roundNumberLabel.text = "Round " + (GameManager.Instance.MatchDetails.CurrentRoundNumber + 1) + "/" + GameManager.Instance.MatchDetails.MaxRounds + " (" + scoringType + ")";
    ...
    public void OpponentAvatarDown()
    {
        ...
        {
            opponentCategoryBox.SetCurrentlySelectedCategory(ScoringManager.Instance.GetCategoryManager.GetCategory(round.CategoryName), true);
        }
