...
public class DashboardRow : MonoBehaviour
{
    ...
    private void Refresh()
    {
        ...
        roundLabel.text = "Round " + (MatchInfo.CurrentRoundNumber + 1) + "/" + MatchInfo.MaxRounds + " (" + GameManager.ModeName(MatchInfo.ScoringType) + ")";
        ...
        if (MatchInfo.Users.Count == 1)
        {
            ...
            if (MatchInfo.IsDaily)
            {
                ...
                dailyGameLabel.text = "DAILY - " + MatchInfo.DateStringShort;
            }
            else
