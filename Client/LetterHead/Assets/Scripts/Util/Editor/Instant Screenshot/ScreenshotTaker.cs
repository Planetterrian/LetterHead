...
public class Screenshot : EditorWindow
{
    ...
    [MenuItem("Tools/Saad Khawaja/Editor SS X2")]
    private static void SS2()
    {
        Application.CaptureScreenshot(System.DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss") + ".png", 2);
    }


    [MenuItem("Tools/Saad Khawaja/Editor SS X3")]
    private static void SS3()
    {
        Application.CaptureScreenshot(System.DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss") + ".png", 3);
    }
