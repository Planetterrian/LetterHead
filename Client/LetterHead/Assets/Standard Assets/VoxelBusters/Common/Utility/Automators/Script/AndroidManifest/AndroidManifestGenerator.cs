...
namespace VoxelBusters.Utility
{
    public partial class AndroidManifestGenerator
    {
        ...
        public void SaveManifest(string _packageName, string _versionCode, string _versionName, string _path)
        {
            ...
            using (XmlWriter _xmlWriter = XmlWriter.Create(_path, _settings))
            {
                _xmlWriter.WriteStartDocument();
                {
                    ...
                    _xmlWriter.WriteAttributeString("android", "versionCode", null, _versionCode);
                    _xmlWriter.WriteAttributeString("android", "versionName", null, _versionName);
        ...
        protected void WriteActivity(XmlWriter _xmlWriter, string _name, string _theme = null, string _orientation = null, string _configChanges = null, string _exported = null, string _comment = null)
        {
            ...
            {
                _xmlWriter.WriteAttributeString("android", "name", null, _name);

                if (_theme != null)
                    _xmlWriter.WriteAttributeString("android", "theme", null, _theme);

                if (_orientation != null)
                    _xmlWriter.WriteAttributeString("android", "screenOrientation", null, _orientation);

                if (_configChanges != null)
                    _xmlWriter.WriteAttributeString("android", "configChanges", null, _configChanges);

                if (_exported != null)
                    _xmlWriter.WriteAttributeString("android", "exported", null, _exported);
        ...
        protected void WriteAction(XmlWriter _xmlWriter, string _name, string _permission = null, string _comment = null)
        {
            ...
            _xmlWriter.WriteStartElement("action");
            {
                ...
                if (_permission != null)
                    _xmlWriter.WriteAttributeString("android", "permission", null, _permission);
            }
            _xmlWriter.WriteEndElement();
        }
        ...
        protected void WritePermission(XmlWriter _xmlWriter, string _name, string _protectionLevel, string _comment = null)
        {
            ...
            {
                _xmlWriter.WriteAttributeString("android", "name", null, _name);
                _xmlWriter.WriteAttributeString("android", "protectionLevel", null, _protectionLevel);
            }
            _xmlWriter.WriteEndElement();
        }
        ...
        protected void WriteUsesPermission(XmlWriter _xmlWriter, string _name, Feature[] _features = null, string _comment = null)
        {
            ...
            if (_features != null)
            {
                ...
                for (int _iter = 0; _iter < _count; _iter++)
                {
                    ...
                    {
                        _xmlWriter.WriteAttributeString("android", "name", null, _curFeature.Name);
                        _xmlWriter.WriteAttributeString("android", "required", null, _curFeature.Required ? "true" : "false");
                    }
                    _xmlWriter.WriteEndElement();
                }
            }
