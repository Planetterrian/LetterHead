    ...
    public class NPAndroidManifestGenerator : AndroidManifestGenerator
    {
        ...
        private void WriteProviderInfo(XmlWriter _xmlWriter)
        {
            ...
            _xmlWriter.WriteStartElement("provider");
            {
                ...
                _xmlWriter.WriteAttributeString("android", "name", null, "com.voxelbusters.nativeplugins.extensions.FileProviderExtended");
                _xmlWriter.WriteAttributeString("android", "authorities", null, string.Format("{0}.fileprovider", PlayerSettings.GetBundleIdentifier()));
                _xmlWriter.WriteAttributeString("android", "exported", null, "false");
                _xmlWriter.WriteAttributeString("android", "grantUriPermissions", null, "true");

                _xmlWriter.WriteStartElement("meta-data");
                {
                    _xmlWriter.WriteAttributeString("android", "name", null, "android.support.FILE_PROVIDER_PATHS");
                    _xmlWriter.WriteAttributeString("android", "resource", null, "@xml/nativeplugins_file_paths");
                }
        ...
        private void WriteReceiverInfo(XmlWriter _xmlWriter)
        {
            ...
            if (m_supportedFeatures.UsesBilling)
            {
                ...
                {
                    _xmlWriter.WriteAttributeString("android", "name", null, "com.amazon.device.iap.ResponseReceiver");
            ...
            if (m_supportedFeatures.UsesNotificationService)
            {
                ...
                _xmlWriter.WriteStartElement("receiver");
                {
                    ...
                    _xmlWriter.WriteAttributeString("android", "name", null, "com.voxelbusters.nativeplugins.features.notification.serviceprovider.gcm.GCMBroadcastReceiver");
                    _xmlWriter.WriteAttributeString("android", "permission", null, "com.google.android.c2dm.permission.SEND");
            ...
            if (m_supportedFeatures.UsesNotificationService)
            {
                ...
                _xmlWriter.WriteStartElement("receiver");
                {
                    _xmlWriter.WriteAttributeString("android", "name", null, "com.voxelbusters.nativeplugins.features.notification.core.AlarmEventReceiver");
                }
                _xmlWriter.WriteEndElement();
            }
#endif
        ...
        private void WriteMetaInfo(XmlWriter _xmlWriter)
        {
            ...
            _xmlWriter.WriteStartElement("meta-data");
            {
                _xmlWriter.WriteAttributeString("android", "name", null, "com.google.android.gms.games.APP_ID");
                _xmlWriter.WriteAttributeString("android", "value", null, string.Format("\\ {0}", NPSettings.GameServicesSettings.Android.PlayServicesApplicationID));// Space Added because its getting considered as integer when added from xml instead of string.
            }
            _xmlWriter.WriteEndElement();
#endif
        }
