        ...
        public void SwitchExample(string newExample)
        {
            ...
            switch (newExample)
            {
                case "HorizontalPaginationExample":
                    HorizontalPaginationExample.gameObject.SetActive(true);
                    break;
                case "VerticalPaginationExample":
                    VerticalPaginationExample.gameObject.SetActive(true);
                    break;
                case "DynamicPagesExample":
                    DynamicPagesExample.gameObject.SetActive(true);
                    break;
                case "SliderExample":
                    SliderExample.gameObject.SetActive(true);
                    break;
                case "CharacterCreationExample":
                    CharacterCreationExample.gameObject.SetActive(true);
                    break;
                case "SliderScrollRectExample":
                    SliderScrollRectExample.gameObject.SetActive(true);                    
                    break;
            }
        }
